...
const Header = () => {
  ...
  return (
    <div className="relative px-[1rem] lg:px-[4rem] xl:px-[6rem] 2xl:px-[8rem] mt-14 lg:mt-10 flex justify-between items-center ">
      {/* logo */}
      <Link to="/">
        <img src="./logo.png" className="w-[6rem] md:w-[10rem] sm:w-[4rem] lg:w-[10rem] xl:w-52" alt="" />
      </Link>

      {/* countdown */}
      <div className="px-3 rounded-3xl absolute -top-[80%] lg:pt-5 xl:pt-10 2xl:pt-12 pb-2.5 left-[50%] -translate-x-1/2 bg-[#840000]
      ...
      <div className="flex gap-10 pr-5 relative">
        {/* contactus button */}
        <Link to="/contact">
          <button
            className="border-4 border-[rgba(196,1,0,0.3)] bg-[#6F0000] 
           px-4 py-2 -skew-x-6 rounded-[10px] sm:text-[5px] md:text-[15px] lg:text-[10px] xl:text-[12px]"
          >
            CONTACT US
          </button>
        </Link>
